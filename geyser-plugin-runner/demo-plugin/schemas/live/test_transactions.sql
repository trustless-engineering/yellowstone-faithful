...
-- --------------------------------
-- Add unique_signers and transaction_version columns:
-- ALTER TABLE test_transactions
--   ADD COLUMN IF NOT EXISTS unique_signers Array(String) AFTER signers,
--   ADD COLUMN IF NOT EXISTS transaction_version String AFTER compute_units_consumed;
...
CREATE TABLE test_transactions (
    ...
    unique_signers Array(String),
    -- list of unique signers for the transaction
    is_vote Boolean,
    ...
    -- transaction version as determined by the ReplicaTransactionInfoVersions enum
